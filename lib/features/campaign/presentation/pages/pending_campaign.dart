...
class PendingCampaign extends StatefulWidget {
  const PendingCampaign({super.key});

  @override
  State<PendingCampaign> createState() => _PendingCampaignState();
}

class _PendingCampaignState extends State<PendingCampaign> {
  @override
  void initState() {
    super.initState();
    context.read<CampaignCubit>().getMyCampaigns(camapignStatus: "PENDING");
  }
