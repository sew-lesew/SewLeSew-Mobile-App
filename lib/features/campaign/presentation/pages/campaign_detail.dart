...
class _CampaignDetailScreenState extends State<CampaignDetailScreen> {
  ...
  void initState() {
    super.initState();
    context.read().getCampaignById(widget.campaignId!);
  }
      ...
      body: BlocBuilder<CampaignCubit,
        ...
        builder: (context, state) {
          ...
          if (state.failure != null) {
            return Center(child: Text("Error: ${dartz.Left(state.failure!)}"));
          }
          ...
          final CampaignDetailEntity campaign = (data as dartz.Right).value;
